...
class Scorebord():
	...
	def prep_score(self):
		...
		# Вывод счета в правой верхней части екрана
	...
	def prep_ships(self):
		'''Сообщает про колличесвто оставшихся кораблей'''
		self.ships = Group()
	...
	def show_score(self):
		'''Вывод счет, рекорд и число оставшихся кораблей на екран'''
		self.screen.blit(self.score_image, self.score_rect)
		self.screen.blit(self.high_score_image, self.high_score_rect)
		self.screen.blit(self.level_image, self.level_rect)
		# Вывод кораблей на екран
